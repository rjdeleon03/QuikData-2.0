...
class IncomeBeforeAdapter(context: Context, rowSaveListener: (IncomeBeforeRow) -> Unit) :
    BaseAdapter<IncomeBeforeRow, IncomeBeforeAdapter.ViewHolder>(context, R.layout.item_income, rowSaveListener) {

    override fun createViewHolder(view: View): ViewHolder = ViewHolder(view)

    class ViewHolder(itemView: View) : BaseAdapter.ViewHolder<IncomeBeforeRow>(itemView) {
