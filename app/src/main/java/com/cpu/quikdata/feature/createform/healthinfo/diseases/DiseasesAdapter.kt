...
class DiseasesAdapter @AssistedInject constructor(
    context: Context,
    @Assisted rowSaveListener: (DiseasesRow) -> Unit,
    ...
    interface Factory {
        fun create(rowSaveListener: (DiseasesRow) -> Unit, expandedItem: Int): DiseasesAdapter
    }
