...
class IncomeAfterAdapter @AssistedInject constructor (
    ...
    BaseAssistanceAdapter<IncomeAfterRow, IncomeAfterAdapter.ViewHolder>(context, rowSaveListener, deleteClickListener, R.layout.item_income, expandedItem) {

    @AssistedInject.Factory
    interface Factory {
        fun create(rowSaveListener: (IncomeAfterRow) -> Unit,
                   deleteClickListener: (IncomeAfterRow) -> Unit,
                   expandedItem: Int): IncomeAfterAdapter
    }
