...
class CaseStoriesViewModel @Inject constructor(private val mRepository: CaseStoriesRepository) :
    ...
    fun insertImage(uri: String, id: String) = runOnIoThread { mRepository.insertImage(uri, id) }

    fun deleteImage(data: CaseStoriesImageItem) = runOnIoThread { mRepository.deleteImage(data) }
}
