...
@Entity(tableName = "health_assistance_row",
...
data class HealthAssistanceRow(@PrimaryKey(autoGenerate = false)
    ...
    override fun equals(other: Any?): Boolean {
        if (other == null || other !is HealthAssistanceRow) return false
