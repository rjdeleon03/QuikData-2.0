...
@Entity(tableName = "food_security_assistance_row",
...
data class FoodSecurityAssistanceRow(@PrimaryKey(autoGenerate = false)
    ...
    override fun equals(other: Any?): Boolean {
        if (other == null || other !is FoodSecurityAssistanceRow) return false
