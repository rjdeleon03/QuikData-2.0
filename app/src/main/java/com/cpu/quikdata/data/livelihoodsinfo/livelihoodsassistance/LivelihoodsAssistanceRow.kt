...
@Entity(tableName = "livelihoods_assistance_row",
...
data class LivelihoodsAssistanceRow(@PrimaryKey(autoGenerate = false)
    ...
    override fun equals(other: Any?): Boolean {
        if (other == null || other !is LivelihoodsAssistanceRow) return false
